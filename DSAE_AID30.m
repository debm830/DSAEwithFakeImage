...
load('/Users/debm830/WorkSpace/matlab_ws/DSAE-master/gnd_AID30.mat');
gnd = gnd_n;
nnClass = length(unique(gnd)); 

load('/Users/debm830/WorkSpace/matlab_ws/DSAE-master/Features/word2vec_attribute_aid30.mat');
F_attribute = word2vec_attribute; 


load('/Users/debm830/WorkSpace/matlab_ws/DSAE-master/featuresAID30.mat');

[~,~,~,new_data2] = PCA(features,options);
